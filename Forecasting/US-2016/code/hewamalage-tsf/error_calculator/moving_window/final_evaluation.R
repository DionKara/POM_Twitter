...
root_directory = paste(dirname(getwd()), "hewamalage-tsf", sep = "/")
...
errors_file_full_name_mean_median = paste(paste(root_directory, "results/errors", sep = "/"), errors_file_name_mean_median, sep = '/')
SMAPE_file_full_name_all_errors = paste(paste(root_directory, "results/errors", sep = "/"), SMAPE_file_name_all_errors, sep = '/')
MASE_file_full_name_all_errors = paste(paste(root_directory, "results/errors", sep = "/"), MASE_file_name_all_errors, sep = '/')
...
processed_forecasts_file <- paste(paste(root_directory, "results/processed_rnn_forecasts/", sep = "/"), errors_file_name, sep = "")
