...
def invoke_r_script(args, moving_window):
    if moving_window:
        subprocess.call(["C:/Program Files/R/R-4.1.0/bin/Rscript.exe", "--vanilla", "error_calculator/moving_window/final_evaluation.R", args[0], model_testing_configs.RNN_ERRORS_DIRECTORY, model_testing_configs.PROCESSED_RNN_FORECASTS_DIRECTORY, args[1], args[2], args[3], args[4], args[5], args[6], args[7], args[8], args[9], args[10], args[11]], shell=True)
    else:
